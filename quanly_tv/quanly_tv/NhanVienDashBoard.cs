...
namespace quanly_tv
{
    public partial class NhanVienDashBoard : Form
    {
        public NhanVienDashBoard()
        {
            InitializeComponent();
        }

        private void NhanVienDashBoard_VisibleChanged(object sender, EventArgs e)
        {
            themsach1.Visible = false;
            themtacgia1.Visible = false;
            themloaisach1.Visible = false;
            themdocgia1.Visible = false;
            passwordnv1.Visible = false;
            themnxb1.Visible = false;
            muonsach1.Visible = false;
            btn_themsach.PerformClick();
            passwordnv1.setIDValue(IDValue);
        ...
        private void NhanVienDashBoard_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult result;
